...
trait FileSaver
{
    ...
    */
    ...
    {
        //dd($file, $model, $database_field_name, $basePath, $width, $height);
        if ($file) {
...
//                if (file_exists($basePath . '/' . $model->$database_field_name) && $model->image != '') {
//                    unlink($basePath . '/' . $model->$database_field_name);
//                }
