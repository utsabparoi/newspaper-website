                                        ...
                                        <div class="post-block-style clearfix">
                                            <div class="post-thumb">
                                                <a href='{{URL::to("article/$featured->id/$featured->link")}}'>
                                                    ...
                                                    <img style="max-height: 180px;min-height: 180px" class="img-responsive"
                                                        src="{{asset($featured->photo)}}" alt="{{$featured->title}}" />
                                                    @else
                                                    <img style="max-height: 180px;min-height: 180px" class="img-responsive"
                                                        src="{{asset('img/news/'.$featured->photo)}}" alt="news image" />
                                                    @endif
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane {{($j>1)?'':'active'}} animated fadeInRight" id="tab_{{$j}}">
                                    <div class="row">
                                        ...
                                        @if($key<= 0) <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="post-thumb">
                                                    <a href='{{URL::to("article/$news->id/$news->link")}}'>
                                                        ...
                                                        <img style="max-height: 220px;min-height: 220px;min-width: 100%"
                                                            class="img-responsive" src="{{asset($news->photo)}}"
                                                            alt="{{$news->title}}" />
                                                        @else
                                                        <img style="max-height: 220px;min-height: 220px;min-width: 100%"
                                                            class="img-responsive" src="{{asset('img/news/'.$news->photo)}}"
                                                            alt="{{$news->title}}" />
                                                        @endif
            ...
            @if ($category->serial_num == 5)
                <div style="margin-top: 20px" class="featured-tab color-red">
                    ...
                    <div class="tab-content">
                        ...
                        <?php $j++; ?>
                        <div class="tab-pane {{($key == 0)?'active':''}} animated fadeInRight" id="tab52_{{$j}}">
                                    ...
                                    <div style="max-width: " class="post-block-style clearfix">
                                        <div class="post-thumb">
                                            <a href='{{URL::to("article/$news->id/$news->link")}}'>
                                                ...
                                                <img style="max-height: 220px;min-height: 220px;min-width: 100%"
                                                    class="img-responsive" src="{{asset('img/news/images.png')}}" alt="image">
                                                <?php } ?>
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="sidebar sidebar-right">
            ...
            <div class="widget color-red">
                ...
                <div class="fb-page" data-href="{{$info->fb_link}}" data-tabs="timeline, messages" data-height="250"
                                    ...
                                    <div class="post-thumb">
                                        <a href="#">
                                            ...
                                            <img style="max-height: 220px;min-height: 220px;min-width: 100%" class="img-responsive"
                                                src="{{asset($c_news7->photo)}}" alt="{{$c_news7->title}}" />
                                            @else
                                            <img style="max-height: 220px;min-height: 220px;min-width: 100%" class="img-responsive"
                                                src="{{asset('img/news/'.$c_news7->photo)}}" alt="{{$c_news7->title}}" />
                                            @endif
                                            ...
                                            <div class="post-block-style post-float clearfix">
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        ...
                                                        @else
                                                        <img style="max-height: 80px;min-height: 80px;min-width: 100%"
                                                            class="img-responsive" src="{{asset('img/news/'.$c_news7->photo)}}"
                                                            alt="{{$c_news7->title}}" />
                                                        @endif
                                ...
                                <div class="post-overaly-style clearfix">
                                    <div class="post-thumb">
                                        <a href="#">
                                            ...
                                            <img style="max-height: 220px;min-height: 220px;min-width: 100%" class="img-responsive"
                                                src="{{asset($c_news8->photo)}}" alt="{{$c_news8->title}}" />
                                            @else
                                            <img style="max-height: 220px;min-height: 220px;min-width: 100%" class="img-responsive"
                                                src="{{asset('img/news/'.$c_news8->photo)}}" alt="{{$c_news8->title}}" />
                                            @endif
                                            ...
                                            <div class="post-block-style post-float clearfix">
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        ...
                                                        @else
                                                        <img style="max-height: 80px;min-height: 80px;min-width: 100%"
                                                            class="img-responsive" src="{{asset('img/news/'.$c_news8->photo)}}"
                                                            alt="{{$c_news8->title}}" />
                                                        @endif
                ...
                @if ($category->serial_num == 6)
                    <div style="margin-top: 20px" class="featured-tab color-red">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="{{($m>7)?'':'active'}}">
                                <a class="animated fadeIn" href="#tab66_{{$m}}" data-toggle="tab">
                                    <span class="tab-head">
                        ...
                        <div class="tab-content">
                            ...
                            <?php $n++; ?>
                            <div class="tab-pane {{($n>7)?'':'active'}} animated fadeInRight" id="tab66_{{$n}}">
                                        ...
                                        <div style="max-width: " class="post-block-style clearfix">
                                            <div class="post-thumb">
                                                <a href='{{URL::to("article/$news6->id/$news6->link")}}'>
                                                    ...
                                                    <img style="max-height: 220px;min-height: 220px;min-width: 100%"
                                                        class="img-responsive" src="{{asset($news6->photo)}}"
                                                        alt="{{$news6->title}}" />
                                                    @else
                                                    <img style="max-height: 220px;min-height: 220px;min-width: 100%"
                                                        class="img-responsive" src="{{asset('img/news/'.$news6->photo)}}"
                                                        alt="{{$news6->title}}" />
                                                    @endif
