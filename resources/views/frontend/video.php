					...
					<div class="col-md-7 pad-r-0">
						<div class="tab-content">
							<div class="tab-pane active animated fadeIn" id="video1">
								<div class="post-overaly-style clearfix">
								   <div class="post-thumb">
										<img class="img-responsive" src="{{asset('public/frontend/images/news/video/video4.jpg')}}" alt="" />
										<a class="popup" href="{{asset('public/frontend/images/news/video/video4.jpg')}}">
							...
							<div class="tab-pane animated fadeIn" id="video2">
								<div class="post-overaly-style clearfix">
								   <div class="post-thumb">
								      <img class="img-responsive" src="{{asset('public/frontend/images/news/video/video3.jpg')}}" alt="" />
							...
							<div class="tab-pane animated fadeIn" id="video3">
								<div class="post-overaly-style clearfix">
								   <div class="post-thumb">
								      <img class="img-responsive" src="{{asset('public/frontend/images/news/video/video2.jpg')}}" alt="" />
