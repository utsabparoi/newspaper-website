                    ...
                    <form action="{{ route('class-sub-category.store') }}" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="left col-lg-5" style="margin-left: 20px">
                                ...
                                <div class="form-group">
                                    <label class=" control-label no-padding-right" for="form-field-1"> Sub Category Name </label>
                                    <div >
                                        <input name="name" type="text" id="form-field-1" placeholder="Sub Category Name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class=" control-label no-padding-right" for="form-field-1"> Sub Category link </label>
                                    <div >
                                        <input name="link" type="text" id="form-field-1" placeholder="Sub Category link " class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class=" control-label no-padding-right" for="form-field-1"> Sub Category serial num </label>
                                    <div >
