        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Edit Ads Placement</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="page-header widget-header">
                    <h4 class="widget-title">
                        <i class="menu-icon fa fa-plus"></i> Edit Ads Placement
                    </h4>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="{{ route('ads-placement.update', $target_place->id) }}" class="form-horizontal" role="form"
                                ...
                                <div class="left col-lg-11" style="margin-left: 20px">
                                        ...
                                        <div>
                                            ...
                                            <select name="ads_position_id" type="number" class="form-control">
                                                ...
                                                @foreach ($ads_position as $position)
                                                    <option value="{{ $position->id }}" {{ $position->id == $target_place->ads_position_id ? 'selected' : "" }}>{{ $position->position_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select name="ads_serial_id" type="number" class="form-control" id="sl-no"
                                                ...
                                                @foreach ($ads_serial as $serial)
                                                    <option value="{{ $serial->id }}" {{ $serial->id == $target_place->ads_serial_id ? 'selected' : "" }}>{{ $serial->serial_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group width-100">
                                            ...
                                            <div class="toggle-btn {{ $target_place->status == 1 ? 'active' : " " }}">
                                                <input type="checkbox" name="status" {{ $target_place->status == 1 ? 'checked' : " " }} class="cb-value" />
