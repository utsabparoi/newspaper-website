    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form action="{{ route('pages-photo.update',$target_ads->id) }}" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <select name="fk_page_id" class="form-control">
                                        ...
                                        @foreach ($all_infos as $all_info)
                                            <option value="{{ $all_info->id }}" {{ ( $all_info->id )== $target_ads->relationtopage->id ? 'selected' : "" }}>{{ $all_info->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div >
                                        ...
                                        @else
                                            <img src="{{asset('assets/backend/page-photo/'.$target_ads->photo)}}" alt="not found" width="100px">
                                        @endif
                                            <br>
                                        <small>size must be 400x600</small>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class=" control-label no-padding-right" for="form-field-2">Choose Photo </label>
                                    <div>
