                                    ...
                                    @forelse ($all_adds as $all_adds)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a href="{{ route('mediaCat_status',$all_adds->id) }}"><i class="fa fa-toggle-off" style="font-size: 24px"></i></a>
                                                @endif
                                            </td>
                                            <td style="display: flex">
                                                <a href="{{ route('media-category.edit',$all_adds->id) }}" style="margin-bottom: 5px"><i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-top: 0px; margin-right: 5px; font-size:22px;"></i></a>
                                                <form action="{{ route('media-category.destroy',$all_adds->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
