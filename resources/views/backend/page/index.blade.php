                                    ...
                                    @forelse ($all_adds as $all_adds)
                                        <tr>
                                            ...
                                            <td style="display: flex; ">
                                                <a href="{{ route('pages.edit',$all_adds->id) }}" style="margin-bottom: 5px"><i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-top: 0px; margin-right: 5px; font-size:22px;"></i></a>
                                                <form action="{{ route('pages.destroy',$all_adds->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
