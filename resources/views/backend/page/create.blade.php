                        ...
                        <div class="row">
                            <div class="left col-lg-11" style="margin-left: 20px">
                                <div class="form-group">
                                    ...
                                    <div >
                                        <input name="name" type="text" id="form-field-1" placeholder="Page name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class=" control-label no-padding-right" for="form-field-1"> Page title </label>
                                    <div >
                                        <input name="title" type="text" id="form-field-1" placeholder="Page title" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class=" control-label no-padding-right" for="form-field-1"> Page link </label>
                                    <div >
                                        <input name="link" type="text" id="form-field-1" placeholder="Page link " class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
