    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form action="{{ route('sub-sub-menu.store') }}" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="left col-lg-5" style="margin-left: 20px">
                                ...
                                <div class="form-group">
                                    ...
                                    <div >
                                        <input name="name" type="text" id="form-field-1" placeholder="Sub Sub Menu Name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class=" control-label no-padding-right" for="form-field-1"> Sub Sub Menu link </label>
                                    <div >
                                        <input name="url" type="text" id="form-field-1" placeholder="Sub Sub Menu link " class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
